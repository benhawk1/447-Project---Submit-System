...
assignmentInfo = pd.read_csv("C:/Users/Zach Gaming/PycharmProjects/447-Project---Submit-System/Web Files/submitsystem/Assignments.csv")
loginInfo = pd.read_csv("C:/Users/Zach Gaming/PycharmProjects/447-Project---Submit-System/Web Files/submitsystem/Users.csv")
...
def recordAssignment(classes, sections, name, dueDate, dueTime):
    ...
    assignmentInfo.to_csv("C:/Users/Zach Gaming/PycharmProjects/447-Project---Submit-System/Web Files/submitsystem/Assignments.csv", index=False)
...
def removeAssignment(name, myClass, mySection):
    ...
    assignmentInfoTemp.to_csv("C:/Users/Zach Gaming/PycharmProjects/447-Project---Submit-System/Web Files/submitsystem/Assignments.csv", index=False)
