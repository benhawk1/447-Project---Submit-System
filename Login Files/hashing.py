...
def encode(password,row,df):
    ...
    df.to_csv("C:/Users/benha/Documents/CMSC 447 Project/Users.csv")
    
#A test case to ensure functionality. Replace string below with desired path
loginInfo = pd.read_csv("C:/Users/benha/Documents/CMSC 447 Project/Users.csv")
encode('Bird24',1,loginInfo)
